...
HARNESSES: dict[str, HarnessSpec] = {
    ...
    "cursor": _spec(
        ...
        skill_sources=("{home}/.cursor/skills", "{home}/.cursor/skills-cursor"),
    ...
    "copilot": _spec(
        ...
        project_markers=(".github/copilot-instructions.md", ".github/agents"),
